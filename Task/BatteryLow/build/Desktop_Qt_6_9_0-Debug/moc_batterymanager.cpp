...
#include "../../../../Qt/BatteryLow/batterymanager.h"
...
void BatteryManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->batteryLow((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (BatteryManager::*)(QString )>(_a, &BatteryManager::batteryLow, 0))
            return;
    }
}
...
// SIGNAL 0
void BatteryManager::batteryLow(QString _t1)
{
